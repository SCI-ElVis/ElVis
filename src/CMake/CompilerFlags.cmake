...
IF( NOT PASSED_FIRST_CONFIGURE )
  ...
  IF( CMAKE_COMPILER_IS_GNUCXX )
    ...
    SET( CMAKE_CXX_FLAGS "${GNU_WARNING_FLAGS} -fstrict-aliasing -Wstrict-aliasing" CACHE STRING "C++ Flags" FORCE)
    IF( NOT CYGWIN )
  ...
  ELSEIF( ${CMAKE_CXX_COMPILER_ID} STREQUAL "Clang")
    ...
    SET( CMAKE_CXX_FLAGS "-Werror -Wall -fstrict-aliasing -Wstrict-aliasing" CACHE STRING "C++ Flags" FORCE)
    IF( APPLE )
      SET( CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -fPIC" CACHE STRING "C++ Flags" FORCE)
    ELSEIF( CYGWIN )
    ELSE()
