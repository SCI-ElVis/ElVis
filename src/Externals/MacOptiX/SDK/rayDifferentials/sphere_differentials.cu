...
static __device__
void intersect_sphere_with_differentials(void)
{
...
{
  intersect_sphere_with_differentials<false>();
}


RT_PROGRAM void robust_intersect(int primIdx)
{
  intersect_sphere_with_differentials<true>();
}
