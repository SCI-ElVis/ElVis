...
IF (APPLE)
    SET(OptiX_Dir ${CMAKE_CURRENT_SOURCE_DIR}/Externals/MacOptiX)
    SET(OptiX_INSTALL_DIR_CMAKE_PATH ${CMAKE_CURRENT_SOURCE_DIR}/Externals/MacOptiX)
ELSEIF(DEFINED ENV{OptiX_INSTALL_DIR})
	FILE(TO_CMAKE_PATH $ENV{OptiX_INSTALL_DIR} OptiX_INSTALL_DIR_CMAKE_PATH)
ELSEIF(EXISTS "C:/Program Files/NVIDIA Corporation/OptiX SDK 3.0.0")
	SET(OptiX_INSTALL_DIR_CMAKE_PATH "C:/Program Files/NVIDIA Corporation/OptiX SDK 3.0.0")
#ELSE(EXISTS "/Developer/OptiX")
#	SET(OptiX_INSTALL_DIR_CMAKE_PATH "/Developer/OptiX")
ENDIF()
