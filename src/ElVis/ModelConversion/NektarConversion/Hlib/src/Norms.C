...
void Tri::Error(const char *string)
{
	int   qt,trip=0;
...
void Quad::Error(const char *string)
{
	int   qt,trip=0;
	double li=0.0,l2=0.0,h1=0.0,areat = 0.0,l2a,h1a,area,store;
	double *s,*utmp;
...
void Tet::Error(const char *string)
{
	int   qt,trip=0;
...
void Pyr::Error(const char *string)
{
	int   qt,trip=0;
	double li=0.0,l2=0.0,h1=0.0,areat = 0.0,l2a,h1a,area,store;
	double *s,*utmp;
...
void Prism::Error(const char *string)
{
	int   qt,trip=0;
	double li=0.0,l2=0.0,h1=0.0,areat = 0.0,l2a,h1a,area,store;
	double *s,*utmp;
...
void Hex::Error(const char *string)
{
	int   qt,trip=0;
	double li=0.0,l2=0.0,h1=0.0,areat = 0.0,l2a,h1a,area,store;
	double *s,*utmp;
...
void  Tri::Verror(double *u, const char *string)
{
	int     qt;
	double *s,*utmp;
	Coord *X = (Coord *)calloc(1,sizeof(Coord));
...
void  Quad::Verror(double *u, const char *string)
{
	int   qt;
	double *s,*utmp;
	Coord *X = (Coord *)malloc(sizeof(Coord));
...
void  Tet::Verror(double *, const char *)
{
	return;
}
...
void  Pyr::Verror(double *, const char *)
{
	return;
}
...
void  Prism::Verror(double *, const char *)
{
	return;
}
...
void  Hex::Verror(double *, const char *)
{
	return;
}
...
void Element::Verror(double *, const char *)
{
	ERR;
}
...
void Element::Norm_l2m(double *, double *)
{
	ERR;
}
...
void Element::Norm_h1m(double *, double  *)
{
	ERR;
}
...
double Tri::L2_error_elmt(const char *string)
{
	int    qt,trip=0;
	double *s,*utmp,l2;
	Coord  *X = (Coord *)calloc(1,sizeof(Coord));
...
double Quad::L2_error_elmt(const char *string)
{
	int    qt,trip=0;
	double *s,*utmp,l2;
	Coord  *X = (Coord *)malloc(sizeof(Coord));
...
double Tet::L2_error_elmt(const char *)
{
...
double Pyr::L2_error_elmt(const char *)
{
...
double Prism::L2_error_elmt(const char *)
{
...
double Hex::L2_error_elmt(const char *)
{
...
double Element::L2_error_elmt(const char *)
{
	return 0.0;
}
...
double Tri::Int_error( const char *string)
{
	int   qt,trip=0;
...
double Quad::Int_error( const char *string)
{
	int   qt,trip=0;
	double *s,*utmp,l2,area;
	Coord *X = (Coord *)malloc(sizeof(Coord));
...
double Tet::Int_error( const char *)
{
	return -1.;
}
...
double Pyr::Int_error( const char *)
{
	return -1.;
}
...
double Prism::Int_error( const char *)
{
	return -1.;
}
...
double Hex::Int_error( const char *)
{
	return -1.;
}
...
double Element::Int_error( const char *)
{
	return 0.0;
}
...
double Tri::H1_error_elmt(const char *string)
{
	int   qt,trip=0;
	double *s,*utmp,h1;
	Coord *X = (Coord *)calloc(1,sizeof(Coord));
...
double Quad::H1_error_elmt(const char *string)
{
	int   qt,trip=0;
	double *s,*utmp,h1;
	Coord *X = (Coord *)malloc(sizeof(Coord));
...
double Tet::H1_error_elmt(const char *)
{
...
double Pyr::H1_error_elmt(const char *)
{
...
double Prism::H1_error_elmt(const char *)
{
...
double Hex::H1_error_elmt(const char *)
{
...
double Element::H1_error_elmt(const char *)
{
	return 0.0;
}
