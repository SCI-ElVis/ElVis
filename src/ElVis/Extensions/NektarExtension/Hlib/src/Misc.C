...
void Element::GetFace(double *, int, double*)
{
	ERR;
}
/*
...
void Element::PutFace(double*, int)
{
	ERR;
}
...
void Tri::Set_field(const char *string)
{
	register int i;
	int   qt;
	Coord X;
...
void Quad::Set_field(const char *string)
{
	register int i;
	int   qt;
	double *s;
...
void Tet::Set_field(const char *string)
{
	register int i;
	int   qt;
	Coord X;
...
void Pyr::Set_field(const char *string)
{
	register int i;
	int   qt;
	Coord X;
...
void Prism::Set_field(const char *string)
{
	register int i;
	int   qt;
	Coord X;
...
void Hex::Set_field(const char *string)
{
	register int i;
	int   qt;
	Coord X;
...
void Element::Set_field(const char *)
{
	ERR;
}         // set field to function
...
void Tri::fill_column(double **Mat, int loc, Bsystem *B, int nm, int offset)
{
	...
	tid = B->nsolve + offset;
	if(N)
		dvadd(N,*face->hj,1,Mat[tid]+loc,nm,Mat[tid]+loc,nm);
}
...
void Element::fill_column(double **, int , Bsystem *, int, int )
{
	ERR;
}
...
void Tri::GetZW(double **za, double **wa, double **zb, double **wb, double **,
				double **)
{
...
void Quad::GetZW(double **za, double **wa, double **zb, double **wb, double **,
				 double **)
{
...
void Tet::GetZW(double **za, double **wa, double **zb, double **wb, double **zc,
				double **wc)
{
...
void Pyr::GetZW(double **za, double **wa, double **zb, double **wb, double **zc,
			    double **wc)
{
...
void Prism::GetZW(double **za, double **wa, double **zb, double **wb,
				  double **zc, double **wc)
{
...
void Hex::GetZW(double **za, double **wa, double **zb, double **wb, double **zc,
			    double **wc)
{
...
void Element::GetZW(double **, double **, double **, double **, double **,
				    double **)
{
	ERR;
}
...
void Element::fillvec(Mode *, double *)
{
	ERR;
}     //
...
double Element::get_1diag_massmat(int )
{
	return 0.0;
}
