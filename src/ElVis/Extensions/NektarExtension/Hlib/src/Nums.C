...
int  Element::ednum(int,int)
{
	ERR;
	return -1;
}

//make new function called ednum2, counter-clockwise orientation defined from 
//inside the elements
