...
void gdmax (double *, int, double *)
{
	error_msg(No message passing routines linked);
}

void gimax (int *, int, int *)
{
	error_msg(No message passing routines linked);
}

void gdsum (double *, int, double *)
{
	error_msg(No message passing routines linked);
}

void gisum (int *, int, int *)
{
	error_msg(No message passing routines linked);
}
#endif
void BCreduce(double *, Bsystem *)
{
	error_msg(No message passing routines linked);
}

void GatherBlockMatrices(Element *, Bsystem *)
{
	error_msg(No message passing routines linked);
}

void Set_Comm_GatherBlockMatrices(Element *, Bsystem *)
{
	error_msg(No message passing routines linked);
}

void parallel_gather(double *, Bsystem *)
{
	error_msg(No message passing routines linked);
}
