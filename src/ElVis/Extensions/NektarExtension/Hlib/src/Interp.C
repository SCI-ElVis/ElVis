...
void Hex::InterpToFace1(int, double *f, double *fi)
{
	dcopy(qa*qb,f,1,fi,1);
...
void Element::InterpToFace1(int , double *, double *)
{
	ERR;
}
...
void Tet::InterpToGaussFace(int from_face, double *from, int qaf, int qbf,
							double *to)
{
...
void Pyr::InterpToGaussFace(int from_face, double *from, int qaf, int qbf,
							double *to)
{
...
void Prism::InterpToGaussFace(int from_face, double *from, int qaf, int qbf,
							  double *to)
{
	double **ima, **imb;
	int  q1, q2;
...
void Hex::InterpToGaussFace(int from_face, double *from, int qag, int qbg,
							double *to)
{
...
void Element::InterpToGaussFace(int,double*,int,int,double*)
{
	ERR;
}
