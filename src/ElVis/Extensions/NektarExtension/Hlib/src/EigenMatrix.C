...
void EigenMatrix(double **a, int n, int bwidth)
{
	...
	if(info)
		error_msg(EigenMatrix -- Info not zero);
...
double FullEigenMatrix(double **a, int n, int lda, int trip)
{
	...
	if(info)
		error_msg("FullEigenMatrix-dgeev--Info is not zero\n");
...
double FullEigenVec(double **a, double *v, int n, int lda)
{
	...
	if(info)
		error_msg("FullEigenVec-dgeev--Info is not zero\n");
