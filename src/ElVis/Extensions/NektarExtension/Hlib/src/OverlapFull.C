...
static void GenPatchesFull(Element_List *U, Bsystem *B);
...
static void A_Full_Column(Element_List *U,  Bsystem *B, int colid, double *col,
						  SolveType Stype)
{
	Overlap *OL = B->overlap;
	double d;
