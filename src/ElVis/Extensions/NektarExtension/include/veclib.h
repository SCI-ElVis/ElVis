...
/* ----------------- SECTION 6: Miscellaneous Functions -------------------- */
	...
	void   polint (double *x, double *y, int n, double xp, double *v,
			       double *err);
	void   spline (int n, double yp1, double ypn, double *x, double *y,
				   double *y2);
	...
	void   fftdf  (double*,int*,int*,int*,int*,int*,double*,int*,int*,int*,
				   int*);
