...
namespace vmath
{
	...
	template<class T>
	void vmul( int n, const T *x, const int incx, T*y,
	...
	/// Add vector z = x+y
	template<class T>
	void vadd( int n, const T *x, const int incx, const T *y,
	           const int incy,  T*z, const int incz)
	{
		while( n-- )
		{
	...
	template<class T>
	void sadd( int n, const T alpha, const T *x,
	...
	template<class T>
	void vsub( int n, const T *x, const int incx, T*y,
	           const int incy,  T*z, const int incz)
	{
		while( n-- )
		{
	...
	/// sqrt y = sqrt(x)
	template<class T>
	void vsqrt(int n, const T *x, const int incx,
	           T *y, const int incy)
	{
		while (n--)
		{
	...
	template<class T>
	void gathr(int n, const T *x, const int *y,
	           T *z)
	{
		while (n--)
			*z++ = *(x + *y++);
	...
	template<class T>
	void scatr(int n, const T *x, const int *y,
	           T *z)
	{
		while (n--)
			*(z + *(y++)) = *(x++);
	...
	template<class T>
	void assmb(int n, const T *x, const int *y,
	           T *z)
	{
		while (n--)
			*(z + *(y++)) += *(x++);
